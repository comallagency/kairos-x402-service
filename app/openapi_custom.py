...
X_GUIDANCE = (
    ...
    "MCP servers matching a need, ranked by semantic relevance against "
    "indexed registries and listings - no account, no payment. Need the "
    "best matches against the full indexed snapshot: POST /discover "
    "(paid, $0.001 in USDC via x402, body {\"q\": \"your need\"}) "
    "returns the top five with their relevance scores. Full agent "
